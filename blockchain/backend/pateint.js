...
exports.addPateint = async function(id, name, age, weight) {
    try {
        ...
        console.log('we here in addPatient')
        ...
        const contract = network.getContract('patient2');

        // Submit the specified transaction.
        // createCar transaction - requires 5 argument, ex: ('createCar', 'CAR12', 'Honda', 'Accord', 'Black', 'Tom')

        await contract.submitTransaction('addPatient', id, name, age, weight);
        console.log('Transaction has been submitted');

        // Disconnect from the gateway.
        await gateway.disconnect();

        response.msg = 'addPatient Transaction has been submitted';
        return response;        
